-- ============================================================
-- KONSULTAN APP - RAB MAKER RPC FUNCTIONS MIGRATION
-- Promoted from docs/DB_RAB_Maker_MVP_Functions.sql.
-- Prerequisite: run after the RAB Maker snapshot model migration.
-- ============================================================
