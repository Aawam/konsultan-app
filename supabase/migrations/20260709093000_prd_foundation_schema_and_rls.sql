-- ============================================================
-- KONSULTAN APP - PRD FOUNDATION SCHEMA/RLS MIGRATION
-- Promoted from docs/DB_PRD_Foundation.sql.
-- Purpose:
...
--
-- Prerequisite: run after the core project schema migration that creates
-- public.proyek and public.perusahaan.
-- ============================================================
