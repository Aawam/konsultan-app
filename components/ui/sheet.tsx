    ...
    <SheetPortal>
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          ...
          "data-[side=right]:inset-y-0 data-[side=right]:right-0 data-[side=right]:h-screen data-[side=right]:w-[560px] data-[side=right]:max-w-[95vw] data-[side=right]:border-l data-[side=right]:data-open:slide-in-from-right data-[side=right]:data-closed:slide-out-to-right supports-[height:100dvh]:data-[side=right]:h-dvh",
          "data-[side=left]:inset-y-0 data-[side=left]:left-0 data-[side=left]:h-screen data-[side=left]:w-[560px] data-[side=left]:max-w-[95vw] data-[side=left]:border-r data-[side=left]:data-open:slide-in-from-left data-[side=left]:data-closed:slide-out-to-left supports-[height:100dvh]:data-[side=left]:h-dvh",
